...
interface CreateWSModalProps {
  ...
  onClose: () => void
  onSubmit: (data: {name: string; description: string; codeBookID?: string}) => void
}
...
export default class CreateWSModal extends React.Component<CreateWSModalProps, CreateWSModalState> {
  public state = {
  ...
  public handleSelectCodeBook = (value: string) => this.setState({codeBookID: value})
    ...
    return (
      <Modal
        ...
        footer={[
          ...
          <Button key="submit" type="primary" onClick={this.handleSubmit} disabled={!valid}>
            Submit
          </Button>
        ]}
      >
