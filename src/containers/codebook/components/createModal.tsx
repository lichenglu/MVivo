...
export default class CreateCBModal extends React.Component<
  CreateCBModalProps,
  CreateCBModalState
> {
  public state = {
      ...
      >
        <Form>
          <StyledFormItem required={true} label="Name:">
            <NameInput
              placeholder="Input the new codebook name here"
              onChange={this.handleNameChange}
            />
          </StyledFormItem>
          <StyledFormItem label="Description:">
            <DescText
              placeholder="What is this codebook for?"
